...
# 1. NODE DATA (with custom metadata)
nodes = [
    {"id": "START", "label": "ENTRY NODE", "shape": "circle", "color": "#4dabf7", "layer": "ingress", "meta": "Source System"},
    
    {"id": "LB", "label": "Load Balancer", "shape": "diamond", "color": "#ff922b", "status": "Active"},
    
    {"id": "W1", "label": "Worker Alpha", "shape": "box", "color": "#51cf66", "load": "12%"},
    {"id": "W2", "label": "Worker Beta", "shape": "box", "color": "#f06595", "load": "88%"},
    
    {"id": "VAL", "label": "Data Validator", "shape": "box", "color": "#cc5de8", "checks": "Schema, Auth"},
    {"id": "RETRY", "label": "Retry Logic", "shape": "ellipse", "color": "#ff8787", "delay": "500ms"},
    
    {"id": "EXIT", "label": "EXIT NODE", "shape": "circle", "color": "#20c997", "layer": "egress", "meta": "Final Destination"}
]

# 2. EDGE DATA - defines the parallel paths and the loops
edges = [
    {"from": "START", "to": "LB", "label": "Request", "secure": True},
    
    # Parallel paths
    {"from": "LB", "to": "W1", "path": "primary"},
    {"from": "LB", "to": "W2", "path": "secondary"},
    
    # Merging to validation
    {"from": "W1", "to": "VAL"},
    {"from": "W2", "to": "VAL"},
    
    # Loopback logic (Forward to Exit or Back to Start)
    {"from": "VAL", "to": "RETRY", "label": "Fail", "dashes": True},
    {"from": "RETRY", "to": "START", "label": "Re-ingress", "dashes": True},
    
    # The final terminal path
    {"from": "VAL", "to": "EXIT", "label": "Success", "width": 3}
]
...
final_html = html_template.replace("JSON_NODES", json.dumps(nodes)).replace("JSON_EDGES", json.dumps(edges))

with open("dual_inspector.html", "w") as f:
    f.write(final_html)

print("Created dual_inspector.html - You can now click both boxes and lines!")
