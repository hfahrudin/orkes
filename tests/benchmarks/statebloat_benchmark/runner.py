...
if __name__ == "__main__":
    ...
    orkes_benchmark_file = script_dir / 'orkes_test.py'
    langgraph_benchmark_file = script_dir / 'langgraph_test.py'

    # Run Orkes benchmark
    print(f"Running Orkes benchmark: {orkes_benchmark_file}")
    orkes_results = run_benchmark_subprocess(str(orkes_benchmark_file))
    print("Orkes benchmark finished.")
    
    # Run Langgraph benchmark
    print(f"Running Langgraph benchmark: {langgraph_benchmark_file}")
    langgraph_results = run_benchmark_subprocess(str(langgraph_benchmark_file))
    ...
    plot_path = results_dir / 'statebloat_benchmark_results.png'
